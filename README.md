# Bob AI  Recommendation System

Bob is an AI agent built to analyze users' virtual collections and provide personalized bottle recommendations. This project implements the RAG (Retrieval-Augmented Generation) component of Bob's recommendation engine.
...
- **Personalized Recommendations**: Analyzes your collection to suggest new one you'll love
...
1. **Data Sources**:
   - Any Food catalog data (500 bottles)
   - User collection data

2. **Vector Database**:
   - Food Words embeddings
...
4. **LLM Recommendation Engine**:
   - Context window with user profile and similar Food data
